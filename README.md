<h1 align="center">👋 Olá, me chamo André Santos</h1>
...
- 🚀 Desenvolvedor Full Stack em formação, com foco no ecossistema JavaScript.
- 🎓 Formado em **Análise e Desenvolvimento de Sistemas (ADS)**.
- 💻 Atualmente estudo e desenvolvo projetos com **React, Next.js, Node.js, TypeScript, MongoDB e PostgreSQL**.
- 🧠 Busco escrever códigos organizados, escaláveis e com boas práticas de desenvolvimento.
- 🌍 Realizei intercâmbio na **Irlanda (2022-2023)**, onde desenvolvi fluência em inglês.
- 🔎 Tenho interesse em desenvolvimento web, arquitetura de software, inovação e tecnologia.
- 🤝 Aberto a oportunidades, colaborações e conexões profissionais.
